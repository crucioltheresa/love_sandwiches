...
def update_worsheet(data, worksheet):
    """
...
def get_last_5_entries_sales():
    ...
    for ind in range(1, 7):
        ...
        columns.append(column[-5:])  # Use the colon to get multiple values
...
def main():
    ...
    update_worsheet(sales_data, "sales")
    new_surplus_data = calculate_surplus_data(sales_data)
    update_worsheet(new_surplus_data, "surplus")
    sales_columns = get_last_5_entries_sales()
    new_stock_data = calculate_stock_data(sales_columns)
    update_worsheet(new_stock_data, "stock")
